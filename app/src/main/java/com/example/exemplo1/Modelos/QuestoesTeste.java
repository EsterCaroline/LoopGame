...
public class QuestoesTeste{
        ...
        public String AlternativasTeste[] []={
        ...
        private String TesteRespostas[]={"Ponteiro","5, e o resultado sera 120","GOTO"," Princípio da Dualidade."," por referência.","elementares e estruturados."," Desvio Condicional Simples.","o sexto número é 512."};

        public String getQuestoesT(int b){
            String QuestaoT= QuestoesT[b];
            return QuestaoT;
        }
        public String getPrimeiraAlternativa(int b){
            String  Alternativa= AlternativasTeste[b][0];
            return Alternativa;
        }
        public String getSegundaAlternativa(int b){
            String Alternativa=AlternativasTeste[b][1];
            return Alternativa;
        }
        public String getTerceiraAlternativa(int b){
            String  Alternativa= AlternativasTeste[b][2];
            return Alternativa;
        }
        public String getQuartaAlternativa(int b){
            String  Alternativa= AlternativasTeste[b][3];
            return Alternativa;
        }
        public String getQuintaAlternativa(int b){
            String  Alternativa= AlternativasTeste[b][4];
            return Alternativa;
        }

        public String getTesteRespostas (int b) {
            String Resposta =TesteRespostas[b];
            return Resposta;
        }
}
